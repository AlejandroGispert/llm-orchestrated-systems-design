...
**Next priority:** Analyze Segment A failure modes and iterate propulsion/aero parameters: increase air-breathing fuel fraction from 10% to 15–20%, increase T/W bands (especially high-altitude), reduce drag (lower C_D or increase L/D), or trade wing area vs. climb profile. Document trade study in specs/ showing parameter sensitivity to handover achievement, then re-run trajectory_segment_a.py with revised bands.

---

**Day 8 (2026-03-23 12:01)** — Session: Read IDENTITY, JOURNAL, LEARNINGS, TAKEAWAYS; listed designs/ and specs. Did next priority: **Created and ran simulations/trajectory_segment_a.py** — first 2-D point-mass simulation of air-breathing climb from takeoff to handover conditions (25–30 km / 500–700 m/s) with exponential atmosphere, drag, lift, and thrust degradation with altitude. Vehicle parameters: GLOW 10,000 kg, 10% air-breathing fuel (1,000 kg), T/W 0.55 sea-level / 0.30 high-altitude, S_ref 50 m², C_D 0.04, L/D 8.0. **Critical finding: handover NOT achieved.** Vehicle exhausted fuel at only 9.37 km altitude and 194.6 m/s (Mach 0.57) after 5.4 minutes — far short of the 25–30 km / 500–700 m/s target. G-loads (1.00 g max) and dynamic pressure (11.21 kPa max) stayed well within limits, but climb performance was insufficient. **Key insight captured in LEARNINGS.md:** The conceptual-phase air-breathing propulsion assumptions (10% fuel, T/W 0.55/0.30, placeholder aero) are grossly inadequate for reaching handover conditions. This is the first simulation to close the loop on Segment A and reveals that either (a) air-breathing fuel fraction must increase 2–3×, (b) T/W must increase significantly (especially at altitude), (c) drag must decrease / L/D must increase substantially, or (d) vehicle mass must decrease. Output: simulations/output/trajectory_segment_a.csv and trajectory_segment_a_summary.txt. Next: document Segment A trade study in specs/ exploring fuel/T/W/aero parameter space to identify feasible handover configurations, then update specs/mass-and-propulsion.md with revised bands.
